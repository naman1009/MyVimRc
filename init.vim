...
tmap <C-l> <Esc><C-w><C-l>
tmap <C-k> <Esc><C-w><C-k>
tmap <C-j> <Esc><C-w><C-j>
tmap <C-h> <Esc><C-w><C-h>

nmap <Leader>fc <Plug>(coc-format)
nmap <Leader>cc <Plug>(coc-fix-current)
nmap <Leader>dh :call CocActionAsync('doHover')<CR>
nmap <Leader>hc <Plug>(coc-diagnostic-info)
nmap <Leader>ca <Plug>(coc-codeaction)
nmap gdr <Plug>(coc-declaration)
noremap <A-J> "add"ap
nmap L $
nmap <Leader>po <C-^>
nmap H ^
